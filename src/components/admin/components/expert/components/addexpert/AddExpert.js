...
class AddExpert extends Component {
  ...
  alertToaste = () => {
    this.props.showtoast({
      text: "Expert Successfully Created",
    ...
    return (
      <div>
        ...
        <div className="d-flex flex-row align-items-center mt-4 pt-5">
          ...
          <div className="main-heading ms-3">{expertText.creatementor}</div>
        </div>
        <div className="form-wrapper-3 mt-4">
          <Formik
            ...
            onSubmit={(values, onSubmitProps) => {
              ...
              this.ExpertAPI.postExpert(values, logo).then((res) => {
                if (res.status) {
                  this.showLoading();
                  this.alertToaste();
