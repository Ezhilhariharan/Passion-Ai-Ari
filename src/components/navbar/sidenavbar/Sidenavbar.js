...
function Sidenavbar() {
  const [pathtype, setstate] = useState(null);
  useEffect(() => {
    ...
    <div className="side-navbar ">
      <div className="sidebar-list ">
        <NavLink exact activeClassName="selected" to="/home">
          ...
          >
            <path
              d="M1 10.4888L13.1999 1L25.3999 10.4888V25.3999C25.3999 26.1189 25.1142 26.8085 24.6058 27.3169C24.0974 27.8253 23.4078 28.111 22.6888 28.111H3.7111C2.99207 28.111 2.30249 27.8253 1.79406 27.3169C1.28563 26.8085 1 26.1189 1 25.3999V10.4888Z"
              stroke="white"
              stroke-width="2"
            ...
            />
            <path
              d="M9.13379 28.1102V14.5547H17.2671V28.1102"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      {pathtype ? null : (
        <div className="sidebar-list">
          <NavLink activeClassName="selected" to="/course">
            <svg
              width="20"
              height="31"
              viewBox="0 0 20 31"
            ...
            >
              ...
              />
              <path
                d="M5.127 17.5734L3.57129 29.2863L9.99986 25.4291L16.4284 29.2863L14.8727 17.5605"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
      ...
      <div className="sidebar-list">
        <NavLink activeClassName="selected" to="/appointment">
          {/* <div className="sidebar-list"> */}
          <svg
            width="20"
            height="30"
          ...
          >
            <path
              d="M9.60128 23.1166C14.3516 23.1166 18.2026 19.2657 18.2026 14.5153C18.2026 9.76499 14.3516 5.91406 9.60128 5.91406C4.85092 5.91406 1 9.76499 1 14.5153C1 19.2657 4.85092 23.1166 9.60128 23.1166Z"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M9.60059 10.8301V14.5163L11.4437 16.3595"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M4.05916 7.94248L4.48923 3.23635C4.5444 2.62576 4.82582 2.05784 5.27823 1.64407C5.73064 1.23031 6.32136 1.0006 6.93445 1.00002H12.2795C12.8947 0.997524 13.4885 1.22586 13.9435 1.63992C14.3985 2.05398 14.6817 2.62364 14.737 3.23635L15.1671 7.94248M15.1425 21.0902L14.7125 25.7963C14.6571 26.409 14.3739 26.9787 13.9189 27.3927C13.4639 27.8068 12.8702 28.0351 12.255 28.0326H6.93445C6.31925 28.0351 5.72548 27.8068 5.27047 27.3927C4.81546 26.9787 4.5323 26.409 4.47694 25.7963L4.04688 21.0902H15.1425Z"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      <div className="sidebar-list">
        <NavLink activeClassName="selected" to="/profile">
          ...
          >
            <path
              d="M24.7778 27.7507V24.7784C24.7778 23.2019 24.1515 21.6899 23.0367 20.5751C21.9219 19.4603 20.4099 18.834 18.8333 18.834H6.94444C5.36788 18.834 3.85589 19.4603 2.74109 20.5751C1.62629 21.6899 1 23.2019 1 24.7784V27.7507"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M12.8888 12.8889C16.1718 12.8889 18.8332 10.2275 18.8332 6.94444C18.8332 3.66142 16.1718 1 12.8888 1C9.60575 1 6.94434 3.66142 6.94434 6.94444C6.94434 10.2275 9.60575 12.8889 12.8888 12.8889Z"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      <div className="sidebar-list">
        <NavLink activeClassName="selected" to="/setting">
          ...
          >
            <path
              d="M13.9996 17.546C15.9577 17.546 17.545 15.9586 17.545 14.0005C17.545 12.0424 15.9577 10.4551 13.9996 10.4551C12.0415 10.4551 10.4541 12.0424 10.4541 14.0005C10.4541 15.9586 12.0415 17.546 13.9996 17.546Z"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      <div className="sidebar-list ">
        <NavLink exact activeClassName="selected" to="/chat">
          <svg
            width="34"
            height="25"
            viewBox="0 0 34 25"
          ...
          >
            <path
              d="M1 5C1 2.79086 2.79086 1 5 1H29C31.2091 1 33 2.79086 33 5V20C33 22.2091 31.2091 24 29 24H5C2.79086 24 1 22.2091 1 20V5Z"
              stroke="white"
              stroke-width="2"
            />
